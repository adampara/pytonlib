...
updated on Mon Dec  6 10:31:30 CST 2021

add a version find_pulses_raw without the smoothing
...
def find_pulses_raw(waveform, cut=50, cut_low = 5, nlow = 5,nsm_sipm = 5,  debug=False):
    """ 
    find all regions where waveform is above cut
    smooth_out the waveform, subtract pedestal
